...
const styles = StyleSheet.create({
  ...
  containerFull:{
    ...
    containerr:{
    height:'5%',width:'100%',borderWidth:1,borderColor:"black",alignItems:"center",justifyContent:'center',flexDirection:"row"
    },

    containerrr:{
      height:'5%',width:'100%',borderWidth:1,borderColor:"black",alignItems:"center",backgroundColor:'grey',justifyContent:'center',flexDirection:"row"
      }
})


export default LaudoProAct = ({route,navigation }) => {
   const emailCliente64 = useSelector( state => state.criarPedido.emailCliente64 );
const [pedido, setPedido ] = useState();
const [ laudoAssinado, setLaudoAssinado] = useState();
             ...
             <View style={{flex:3,flexDirection:'row',flexWrap:'wrap'}}>
                    ...
                    <View style={styles.container}>
                     ...
                     <View style={{flex:1,flexDirection:'row',flexWrap:'wrap',alignItems:'center'}}>
                       ...
                       <ScrollView  contentContainerStyle={{height:2500,width:'100%'}} > 
                     ...
                     <Text style={{fontWeight:'bold',marginTop:10,fontSize:13,marginLeft:'35%'}} >Os Documentos Apresenados estao compativeis entre si</Text>
                     <View style={{flex:1,alignItems:'center',justifyContent:"center"}}>
                           <Text> {pedido.inputConclusaoDocumentos} </Text>
                     </View>

                     <Text style={{fontWeight:'bold',marginTop:10,fontSize:13,marginLeft:'35%'}} >Conclusao Proposta</Text>
                     <View style={{flex:1,alignItems:'center',justifyContent:"center"}}>
                           <Text>{pedido.inputConclusaoProposta}</Text>
                     </View>

                     <Text style={{fontWeight:'bold',marginTop:10,fontSize:13,marginLeft:'35%'}} >Orçamento</Text>
                     <View style={{flex:1,alignItems:'center',justifyContent:"center"}}>
                             <Text>{pedido.inputConclusaoOrçamento}</Text>
                     </View>

                     <Text style={{fontWeight:'bold',marginTop:10,fontSize:13,marginLeft:'35%'}} >Cronograma</Text>
                     <View style={{flex:1,alignItems:'center',justifyContent:"center"}}>
                                <Text> {pedido.inputConclusaoCronograma} </Text>
                     </View>

                     <Text style={{fontWeight:'bold',marginTop:10,fontSize:13,marginLeft:'35%'}} >Garantia</Text>
                     <View style={{flex:1,alignItems:'center',justifyContent:"center"}}>
                           <Text> {pedido.inputConclusaoGarantia} </Text>
                     </View>

                     <Text style={{fontWeight:'bold',marginTop:10,fontSize:13,marginLeft:'35%'}} >total</Text>
                     <View style={{flex:1,alignItems:'center',justifyContent:"center"}}>
